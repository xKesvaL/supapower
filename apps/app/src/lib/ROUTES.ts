...
export const PAGES = {
  ...
  "auth_forgot_password": (sp?: Record<string, string | number>) =>  {
        return `/auth/forgot-password${appendSp(sp)}`
      },
  "auth_login": (sp?: Record<string, string | number>) =>  {
        return `/auth/login${appendSp(sp)}`
      },
  "auth_re_auth": (sp?: Record<string, string | number>) =>  {
        return `/auth/re-auth${appendSp(sp)}`
      },
  "auth_register": (sp?: Record<string, string | number>) =>  {
...
export type KIT_ROUTES = { 
  PAGES: { '_ROOT': never, 'admin': never, 'admin_users': never, 'auth': never, 'auth_forgot_password': never, 'auth_login': never, 'auth_re_auth': never, 'auth_register': never, 'nutrition': never, 'nutrition_log': never, 'profile': never, 'profile_username': 'username', 'profile_calendar': never, 'profile_exercises': never, 'profile_measures': never, 'profile_settings': never, 'profile_settings_account': never, 'profile_settings_app': never, 'profile_settings_connections': never, 'profile_settings_contact': never, 'profile_settings_language': never, 'profile_settings_legal': never, 'profile_settings_notifications': never, 'profile_settings_profile': never, 'profile_settings_q_and_a': never, 'profile_settings_theme': never, 'profile_settings_units': never, 'profile_settings_workouts': never, 'profile_statistics': never, 'programs': never, 'programs_community': never, 'programs_self': never, 'train': never, 'train_log': never, 'train_log_add_exercises': never }
